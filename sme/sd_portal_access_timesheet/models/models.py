    ...
    def _timesheet_get_portal_domain(self):
        ...
        if partner.enable_timesheet_portal_access and not partner.access_all_timesheet_records:
            if partner.access_follower_timesheet_records:
                domain += [('task_id.project_id.privacy_visibility', '=', 'portal'),'|',('task_id.partner_id', '=', partner.id),('task_id.message_follower_ids.partner_id', '=', partner.id)]
            else:
                domain += [('task_id.project_id.privacy_visibility', '=', 'portal'),('task_id.partner_id', '=', partner.id)]
            ...
            domain += [('task_id.project_id.privacy_visibility', '=', 'portal'),
                    ...
                    '|',('task_id.partner_id', '=', partner.id),('task_id.message_follower_ids.partner_id', '=', partner.id)
                    ]
            ...
            domain += [ '|','|','|',('task_id.partner_id', 'child_of', partner.parent_id.id),
                     ...
                     ('task_id.partner_id', 'in', partner.child_ids.ids),('task_id.message_follower_ids.partner_id', '=', partner.id),
