...
class PosPayment(models.Model):
    ...
    refunded_id = fields.Char(string="Stripe Refund ID", required=False, )
    ...
    def check(self):
        ...
        if self.payment_method_id.use_payment_terminal == 'sd_pos_stripe_payment_terminal':
            if self.payment_method_id.pos_stripe_api_key:
                ...
                raise ValidationError('No API key provided. Please set stripe API key for selected payment method: {}'.format(self.payment_method_id.name))
