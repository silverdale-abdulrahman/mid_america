...
class ResConfigSettings(models.TransientModel):
    ...
    module_sd_sale_coupon = fields.Boolean(string='Coupons and Promotions')
    module_sd_sale_crm = fields.Boolean(string='Sales on CRM')
    module_sd_payment_stripe_terminal = fields.Boolean(string='Stripe Terminal For Invoice/Quotation')
